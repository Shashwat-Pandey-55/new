...
def appointment():
    if request.method == 'POST':
        ...
        flash('Your appointment has been booked for ' + selected_date, 'success')
        
        # Redirect to the confirmation page and pass the selected_date as a parameter
        print("Redirecting to appointment_confirmation with selected_date:", selected_date)
        return redirect(url_for('appointment_confirmation', selected_date=selected_date))
...
def appointment_confirmation():
    ...
    print(selected_date)
    return render_template('appointment_confirmation.html', selected_date=selected_date)
